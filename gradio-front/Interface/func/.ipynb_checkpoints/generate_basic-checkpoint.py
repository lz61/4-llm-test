...
def find_by_id(id):
    # print(type(id))
    with jsonlines.open("../Data/data_zh.jsonl", "r") as reader:
        for obj in reader:
            # print(type(obj["Id"]))
            # if str(obj["Id"]) == id:
            if obj["Id"] == id:
                ...
                return obj
            # break
    with jsonlines.open("../Data/data_en.jsonl", "r") as reader:
        for obj in reader:
            # print(type(obj["Id"]))
            # if str(obj["Id"]) == id:
            if obj["Id"] == id:
...
def generate_basic_func(article_id, language="Chinese", key_sentences=True):
    data = find_by_id(article_id)
    if data is None:
